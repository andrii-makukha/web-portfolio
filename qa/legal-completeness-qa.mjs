...
// v2.8 final-audit checkpoint: this shared gate intentionally triggers Browser,
// Cross-Browser and Lighthouse exact-head QA when release-readiness rules change.
const requiredFiles = [
  '404.html',
  'sitemap.xml',
  'robots.txt',
